        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
          {buckets.map((bucket) => {
            ...
            return (
              ...
              >
                <div className="bg-slate-50 hover:bg-teal-50 rounded-lg p-8 text-center transition-all duration-300 hover:scale-105 hover:shadow-lg border border-slate-200 hover:border-teal-300">
                  <IconComponent className="w-12 h-12 mx-auto mb-4 text-slate-600 group-hover:text-teal-600 transition-colors" />
                  <h3 className="text-lg font-medium text-slate-800 mb-2">{bucket.title}</h3>
